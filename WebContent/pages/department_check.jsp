...
<script type="text/javascript">
			 ...
			 //实例化资源添加表单面板
			 var departmentCheckGridPanel = new DepartmentCheckGridPanel({myid:subMainId});
			 //设置宽度
			 departmentCheckGridPanel.width = w;
			 //设置高度
			 departmentCheckGridPanel.height = h;
			 //渲染组件
			 departmentCheckGridPanel.render(subMainId+'p');
</script>