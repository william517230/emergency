...
<script type="text/javascript">
			 ...
			 //实例化资源添加表单面板
			 var resourceCheckGridPanel = new ResourceCheckGridPanel({myid:subMainId});
			 //设置宽度
			 resourceCheckGridPanel.width = w;
			 //设置高度
			 resourceCheckGridPanel.height = h;
			 //渲染组件
			 resourceCheckGridPanel.render(subMainId+'p');
</script>