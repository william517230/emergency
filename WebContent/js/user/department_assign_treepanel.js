DepartmentAssignTreepanel = Ext.extend(Ext.tree.TreePanel, {
			myid : null,
			userId : null,
			checkedArray : null,
			// 构造方法
			constructor : function(config) {
				...
				DepartmentShowTreepanel.superclass.constructor.call(this, {
							id : "departmentassigntreepanel",
							autoScroll : true,
							...
							loader : new Ext.tree.TreeLoader({
										...
										dataUrl : "department!findDeptTree.action?userId="+this.userId
